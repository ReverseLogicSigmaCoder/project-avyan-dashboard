...
with tab1:
    ...
    if telemetry_data and "dast_audit" in telemetry_data:
        ...
        # Official CERT-In Report Download Feature
        report_text = f"PROJECT AVYAN - CERT-In MANDATORY INCIDENT REPORT\n" \
                      f"Timestamp: {telemetry_data.get('timestamp')}\n" \
                      f"Target URL: {target_url}\nTarget IP: {target_ip}\n" \
                      f"Status: COMPLIANT WITH CERT-In 6-HOUR WINDOW RULES\n" \
                      f"SUDARSHAN Engine Attestation: Hardware-Software Co-Design Validated"
